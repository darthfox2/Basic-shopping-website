...
public partial class System_EventList : PageBase
{
    new protected int iPageType = 1;
    new protected string strPageID = "L02";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            dtType = clsDAL.GetEveType();
            webCommon.CreateList(ddlType, dtType, "EvtType", "EvtType", true);
