<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.master" AutoEventWireup="true"
    CodeFile="System_EventList.aspx.cs" Inherits="System_EventList" %>
                ...
                <table style="width: 90%;" align="center">
                    ...
                    <tr>
                        <td align="left" style="width: 80%;">
                            <asp:Label ID="Label34" runat="server" SkinID="MainText" Text="事件類別："></asp:Label>
                        ...
                        <td colspan="2">
                            <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="grid_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EvtDesc" HeaderText="事件類別" ReadOnly="True" />
                                    <asp:BoundField DataField="EvrMsg" HeaderText="事件內容" ReadOnly="True">
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetEventByDateRang"
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:ControlParameter ControlID="hideEDate" Name="dtEndSet" PropertyName="Value"
                                        Type="DateTime" />
                                    <asp:ControlParameter ControlID="ddlType" Name="EveType" PropertyName="SelectedValue"
                                        Type="String" />
                                </SelectParameters>
